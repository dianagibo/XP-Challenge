...
const notificationSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['mission_assigned', 'mission_submitted', 'mission_approved', 'mission_changes_requested', 'goal_created', 'goal_completed', 'reward_redeemed', 'reward_delivered', 'bonus_granted', 'bonus_voided'],
    required: true
  },
